...
<%
	...
	String totalSql  = " SELECT COUNT(*) totalCount from film ";
	String resultSql = " SELECT film_id filmId, title from film LIMIT"+" "+ firstIdx + "," + lastIdx;
...
<tr>
	...
	<td><a href="/sakila/db0326/filmOne.jsp?filmId=<%=map.get("filmId")%> "><%=map.get("title")%></a></td>   
</tr>
<%} %>
...
<% if (currentPage < lastPage) { %>
    <a href="/sakila/db0326/filmList.jsp?currentPage=<%= currentPage + 1 %>">다음</a>
<% } %>
